...
import com.xxl.job.core.thread.ExecutorCheckSaveJobInfoThread;
import com.xxl.job.core.thread.ExecutorJobGroupThread;
		...
		thread = new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					// Start initJobGroupCheck-Server
					ExecutorJobGroupThread.getInstance().start(appName);

					// Start Callback-Server
					TriggerCallbackThread.getInstance().start();

					ExecutorCheckSaveJobInfoThread.getInstance().start(appName);
